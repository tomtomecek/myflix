...
describe UsersController do
  ...
  describe "POST create" do
    ...
    context "valid personal input and valid card" do
    ...
    context "valid personal input and declined card" do
      let(:charge) do
      ...
      before do
        StripeWrapper::Charge.should_receive(:create).and_return(charge)
        post :create, user: Fabricate.attributes_for(:user, email: "alice@example.com"), stripeToken: '123123'
      end
    ...
    context "invalid personal input" do
      it "does not create a user" do
        post :create, user: { email: "any@email.com" }
        expect(User.count).to eq(0)
      end
